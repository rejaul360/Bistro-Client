...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar fixed z-10 bg-opacity-50 p-4 text-white bg-black  max-w-7xl mx-auto">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost normal-case text-xl">Bistro Boss <br /> RASTURANT</a>
                </div>
